---
title: "EmoSSR: SSR stimulation frequency"
...
# setwd(paste0(getwd(), "/SSR/stim_freq")) # set working subdir
...
# 
# save_plot(paste0(getwd(), "/pilot1_stimFreq.svg"),
...
# 
# # pilot2
# file.EmoSSR.plot.pilot2 <- EmoSSR.plot.pilot2 +
#   coord_cartesian(ylim = c(0, .8)) +
#   theme(legend.position = c(.95, .99))
# 
# save_plot(paste0(getwd(), "/pilot2_stimFreq.svg"),
#           file.EmoSSR.plot.pilot2,
#           base_aspect_ratio = 1,
#           base_width = 11
# )
# 
...
#   theme(legend.position = c(.95, .99))
# 
# save_plot(paste0(getwd(), "/exp1_stimFreq.svg"),
...
#   theme(legend.position = c(.95, .99))
# 
# save_plot(paste0(getwd(), "/exp2_stimFreq.svg"),
...
- comparison with 0
    - all faces elicit SSR larger than noise, in both orientations
- paired comparisons:
    - orientation
        - all faces elicit similar SSR when upright or inverted
    - regularity
        - regular and irregular faces elicit similar SSR
...
pilot2.model <- brm(CS ~ 0 + condition
...
- comparison with 0
    - all faces elicit SSR larger than noise, in all orientations and within-identity emotion variabilities
- paired comparisons:
    - orientation
        - all faces elicit similar SSR when upright or inverted
    - regularity
        - all faces elicit similar SSR
    - within-identity emotion variability        
        - all faces elicit larger SSR in high compared to low variability, only when upright
...
- paired comparisons:
    - orientation
        - irregular faces elicit larger SSR when upright compared to inverted, in both orientations
        - regular angry faces elicit larger SSR when upright compared to inverted only when within-emotion variability is high
        - regular neutral faces elicit similar SSR when upright and inverted, in both within-emotion variabilities
    - regularity
        - all faces elicit similar SSR
        - exception: irregular faces elicit larger SSR compared to neutral
    - within-identity emotion variability        
        - all faces elicit larger SSR in high compared to low variability
        - exception: angry faces elicit similar SSR in high and low variability when inverted
...
- paired comparisons:
    - orientation
        - upright faces elicit larger SSR when variability is high
        - when variability is low, only irregular faces elicit larger SSR when upright
    - regularity
        - all faces elicit similar SSR
    - within-identity emotion variability        
        - angry faces elicit larger SSR in high variability only when upright
